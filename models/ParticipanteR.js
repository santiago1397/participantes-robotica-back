...
const UserSchema = new mongoose.Schema(
    {
        ...
        pParentName: { type: String, max: 100, },
        pParentLastName: { type: String, max: 100, },
        pParentCi: { type: String, max: 100, },
        pParentPhone: { type: String, max: 100, },
        pParentAddress: { type: String, max: 100, },
